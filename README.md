Below are my collection of best books and references for Backend Engineering study. For each items, I've read / reviewed multiple alternatives and put in the best ones (so you don't have to).
